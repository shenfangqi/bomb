var Popups = cc.Layer.extend({
    ...
    // hidden without animation (for bombman project)
	hidden : function(self, fun) 
	{
		...
		this.blackLayer.removeFromParent();
